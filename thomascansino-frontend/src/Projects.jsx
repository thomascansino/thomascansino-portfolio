    ...
    const projects = [
        {
            ...
            about: "A pet care SAAS platform that connects pet owners with trusted sitters, making it easy to find reliable and trustworthy care for pets during the owner's absence.",
